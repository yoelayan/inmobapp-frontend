...
export default function useSearches(defaultFilters?: Record<string, any>) {
  ...
  const addCharacteristic = useCallback(
    async (id: string, characteristicId: string | number, value: string | number | boolean) => {
  ...
  const deleteCharacteristic = useCallback(
    async (id: string, characteristicId: string | number) => {
  ...
  const addObservation = useCallback(
    async (id: string, observation: string, audio?: File) => {
  ...
  const deleteObservation = useCallback(
    async (id: string, observationId: string | number) => {
  ...
  const getMatchedProperties = useCallback(
    async (searchId: string): Promise<ResponseAPI<IRealProperty>> => {
